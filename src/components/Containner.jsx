...
const Containner = () => {
  ...
  return (
    ...
    <section className="bg-neutral-White grid max-w-[375px] rounded-2xl sm:max-w-4xl sm:grid-cols-2">
     <Values bill={bill} handleBill={handleBill} tipPercentage={tipPercentage} setTipPercentage={setTipPercentage} noOfPeople={noOfPeople} handleNoOfPeople={handleNoOfPeople}/>
     <Result tipAmount={tipAmount} amountPerPerson={amountPerPerson} dimmed={dimmed} handleReset={handleReset}/>
    </section>
  </main>
  )
}
